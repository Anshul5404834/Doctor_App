...
import com.anshul5404834.doctor_app.util.CameraCapturerCompat;
...
public class VideoActivity extends AppCompatActivity {
   ...
   private static String TWILIO_ACCESS_TOKEN = "";
    private static String ACCESS_TOKEN_SERVER = "";
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      //  TWILIO_ACCESS_TOKEN=getIntent().getStringExtra("at");
     //   TWILIO_ACCESS_TOKEN="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCIsImN0eSI6InR3aWxpby1mcGE7dj0xIn0..jcK25ynMOL6KujFoKeouucVSbWXvZntpQOgj6ONMI4o";
        ACCESS_TOKEN_SERVER="https://rekop-help.herokuapp.com/" ;
            //    "?identity=+="+ FirebaseAuth.getInstance().getCurrentUser().getDisplayName()+
           //     "&room="+getIntent().getStringExtra("code");
    ...
    private void setAccessToken() {
        ...
        accessToken=getIntent().getStringExtra("at");
    ...
    private void connectToRoom(String roomName) {
        ...
        ConnectOptions.Builder connectOptionsBuilder = new ConnectOptions.Builder(accessToken)
                .roomName(roomName);
        //1106;
                     ///////////////////changing roomname to name  from intent                //////////////////////////////////////////////////////////////////////
        /*
    ...
    private DialogInterface.OnClickListener connectClickListener() {
        return (DialogInterface dialog, int which) -> {
            /*
             * Connect to room
             */
            //changing arguments of this method from edit text to null
            ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
            connectToRoom(getIntent().getStringExtra("code"));
        };
    }
    ...
    private View.OnClickListener disconnectClickListener() {
        return v -> {
            ...
            if (room != null) {
                room.disconnect();
                Intent intent= new Intent(VideoActivity.this,Thankyou.class);
   ...
   //             });
   // }
 //   ACCESS_TOKEN_SERVER="http://172.20.9.69:3000/" ;
