  ...
  //  private TextView mDetailText;
   ProgressDialog progressDialog;
    ...
    public void onStart() {
        ...
        if(currentUser!=null){
            progressDialog.setMessage(getApplicationContext().getString(R.string.redirecting));

            progressDialog.show();
            Intent i=new Intent(PhoneAuthActivity.this,All_stuff.class);
            startActivity(i);
        }
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            if (task.getException() instanceof FirebaseAuthInvalidCredentialsException) {
                                ...
                                // [START_EXCLUDE silent]
                                mVerificationField.setError(getApplicationContext().getString(R.string.invalid));
                                // [END_EXCLUDE]
                            }
                            // [START_EXCLUDE silent]
                            // Update UI
...
mSignOutButton.setVisibility(View.VISIBLE);
    ...
    private boolean validatePhoneNumber() {
        ...
        if (TextUtils.isEmpty(phoneNumber)) {
            mPhoneNumberField.setError(getApplicationContext().getString(R.string.invalid));
            return false;
        }
        ...
        switch (view.getId()) {
            ...
            case R.id.buttonVerifyPhone:
                ...
                if (TextUtils.isEmpty(code)) {
                    mVerificationField.setError(getApplicationContext().getString(R.string.cannot_be_empty));
                    return;
                }
try{
                verifyPhoneNumberWithCode(mVerificationId, code);}catch (Exception e){Toast.makeText(getApplicationContext(),getApplicationContext().getString(R.string.cant_send_code),Toast.LENGTH_SHORT).show();}
                break;
